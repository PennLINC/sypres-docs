...
full_subgroup_summary <- bind_rows(
  ...
  extract_subgroup_summary(excwl, "Exclude open-label waitlist control"),
...
desired_order <- c(
  "Main model",
  "Depression as primary diagnosis",
  "Exclude open-label waitlist control",
  "Exclude high RoB",
  "Parallel design",
  "Crossover design",
  "Expanded inclusion criteria",
...
```{r eggertest - expanded model, include=FALSE}
# Run Egger's test

eggers.test(expanded$model.overall)
```

```{r funnelplot - expanded model, message=FALSE, results='hide', include=FALSE}
...
print(paste('main n =', total_data_dep))

total_data_excwl <- total_n(data_excwl)
print(paste('main n =', total_data_excwl))

total_data_rob <- total_n(data_rob)
print(paste('main n =', total_data_rob))

total_data_parallel <- total_n(data_parallel)
print(paste('main n =', total_data_parallel))

total_data_crossover <- total_n(data_crossover)
print(paste('main n =', total_data_crossover))

total_data_expanded <- total_n(data_expanded)
print(paste('main n =', total_data_expanded))

total_data_outliers <- total_n(data_outliers)
print(paste('main n =', total_data_outliers))

total_data_fixed <- total_n(data_fixed)
print(paste('main n =', total_data_fixed))

total_data_g10 <- total_n(data_g10)
print(paste('main n =', total_data_g10))

total_data_clinician <- total_n(data_clinician)
print(paste('main n =', total_data_clinician))

total_data_selfreport <- total_n(data_selfreport)
print(paste('main n =', total_data_selfreport))
```
