...
# TODO CHANGE - temp upload from local
...
The model finds that the 95% interval of the true effect lies between -1.22 and -0.55.
...
dev.off()
```
We can visualize each probability distribution below:
![](/analysis/psilodep/paperfigs/SI_Fig_XX.png)
