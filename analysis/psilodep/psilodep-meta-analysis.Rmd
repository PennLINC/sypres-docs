...
```{r load data and impute changes studies, results='hide'}
# Load data
...
```{r run individual meta analyses for paper, warning=FALSE}
...
subgroup_plot
ggsave("psilodep/paperfigs/subgroup_forest_ggplot.png",
...
gtsave(subgroup_table, filename = "psilodep/paperfigs/subgroup_table.png", vwidth = 2000, vheight = 1200, zoom = 10) #setting Zoom higher makes image less blurry/clearer
...
png(filename = "psilodep/paperfigs/response_forest_plot_meta.png", res=315, width=4500, height=1500)
...
png(filename = "psilodep/paperfigs/remission_forest_plot_meta.png", res=315, width=4500, height=1500)
