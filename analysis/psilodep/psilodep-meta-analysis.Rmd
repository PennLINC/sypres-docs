...
cairo_pdf(filename = file.path(basedir, "analysis/psilodep/paperfigs/continuous_forest_plot_meta.pdf"), width = 14.3, height = 4.76)
...
subgroup_plot
ggsave(file.path(basedir, "analysis/psilodep/paperfigs/subgroup_forest_ggplot.pdf"),
  plot = subgroup_plot, width = 10, height = 8, device = cairo_pdf
)
...
cairo_pdf(file.path(basedir, "analysis/psilodep/paperfigs/subgroup_table.pdf"),
          width = 12, height = 6)
grid::grid.draw(tg)
dev.off()
```
