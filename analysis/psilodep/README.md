...
Open RStudio and start a new Project: `File->New Project->From existing directory` and select the `sypres-docs/analysis/psilodep` directory.
...
You will be prompted to answer if this is the first time you're running PSILODEP on this machine. If you respond `y`, you will be asked a second question. Select `1` to restore the project from the lockfile.
...
Is this your first time setting up PSILODEP on this machine? [y/n]: y
...
- Project '~/Documents/GIT/sypres-docs/analysis/psilodep' loaded. [renv 1.0.7]
```
