...
| [`drug-search-inventory.html`](drug-search-inventory.html) | **Drug search inventory** — every drug and development code name in the five search strategies, resolved to compound + developer, plus the Embase-only "psychedelic agent" EMTREE branch terms and the deuterated-DMT (`deudimethyltryptamine`) omission, flagged for team decision | https://claude.ai/code/artifact/c29044c5-94c0-4ce4-b188-c67ee560e854 | 2026-09-09 |
| [`search-term-update-plan.html`](search-term-update-plan.html) | **Search term update plan** — proposed drug-clause revision for all five databases: 11 compounds added (2C-B, DOx, DPT, MDA, MDE, SPL-026, bufotenin, 5-MeO-DiPT, salvinorin A), 4 out-of-scope EMTREE terms dropped, `deudimethyltryptamine` added, MDMT removed. NLM-verified MeSH headings + per-database paste-ready syntax. **Not yet applied to the strategy files.** | https://claude.ai/code/artifact/36060016-515c-40bb-9aae-3bdcbcdc0ad7 | 2026-09-17 |
