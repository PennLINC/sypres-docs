...
meta::forest(main_results$model.overall,
  sortvar = main_results$model.overall$data$year,
  leftcols = c("studlab", "n_arm1", "mean_arm1", "sd_arm1", "condition_arm1", "multi_arm1", "n_arm2", "mean_arm2", "sd_arm2", "condition_arm2", "multi_arm2"),
  leftlabs = c("Study", "N", "Mean","SD", "Drug", "Dose", "N", "Mean", "SD", "Drug", "Dose"),
  fontsize = 9,
  col.square = "#000080",
  col.diamond = "#000080",
  col.predict = "gray",
