...
quartz(type = "pdf", file = file.path(basedir, "analysis/mdmaptsd/paperfigs/dosing_sessions_regression.pdf"), width = 9.51, height = 6.98)
...
quartz(type = "pdf", file = file.path(basedir, "analysis/mdmaptsd/paperfigs/cumulative_dose.pdf"), width = 9.51, height = 6.98)
