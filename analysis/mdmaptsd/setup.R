...
if (basename(getwd()) != "mdmaptsd") {
  stop("Please run this script from the mdmaptsd directory. Start a New Project using the sypres-docs/analysis/mdmaptsd directory if you have not done so already. See README for instructions.")
}
...
is_first_time <- readline(prompt = "Is this your first time setting up MDMAPTSD on this machine? [y/n]: ")
