...
Finally, our Bayesian analysis revealed a Hedges’ *g* posterior distribution centered at \-0.88 \[-1.17; \-0.60\] (**eFigure 7**).

![](/analysis/psilodep/paperfigs/SI_Fig_07.png)
***eFigure 7:*** *Prior (dashed) and posterior (solid) distributions for (**a**) the pooled effect size (Hedges’ *g*) *and (**b**) the heterogeneity estimate (*tau*). *Dark shading represents the 95% probability distribution.*
