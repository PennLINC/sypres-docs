...
We also found that there were significantly higher remission rates with psilocybin compared to control conditions (**SI Figure 5**; *RR* \= 4.19 \[3.52; 4.99\], *p* \< 0.001, *k* \= 6, *n* \= 405), with low between-study heterogeneity (*tau<sup>2</sup>* \= 0.00 \[0.00; 0.00\]; *I<sup>2</sup>* \= 0.00% \[0.00%; 74.62%\]).
