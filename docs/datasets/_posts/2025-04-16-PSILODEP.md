...
publications: https://www.nature.com/articles/s44220-026-00630-8
...
version: 26.0.0
version_url: https://github.com/metapsy-project/data-depression-psiloctr/releases/tag/26.0.0
...
Our three-level CHE model revealed an overall significant decrease in depression scores with psilocybin compared to the control conditions (Hedges’ *g* \= \-0.82 \[-1.08; \-0.55\], *p* \< 0.001, *k* \= 12, *n* \= 619, *tau<sup>2</sup>* \= 0.14 \[0.03; 0.37\], *I<sup>2</sup>* \= 66.7% \[27.5%; 83.6%\]), ensuring that our results were not sensitive to the time point studied. These results were consistent across a range of within study correlation coefficients (**SI Figure 2**).
...
Adding time since final dose as a continuous predictor to our model (**SI Figure 3**) revealed a significant effect favoring psilocybin immediately following dosing (*intercept* \= \-0.87 \[-1.15; \-0.59\], *p* \< 0.0001) that was stable over time (*slope* \= 0.0017 \[-0.0010; 0.0045\], *p* \= 0.20).
